...
int dividirTexto(const char *texto, char *parte1, size_t tamanhoParte1Buffer, char *parte2, size_t tamanhoParte2Buffer)
{
    ...
    if (tamanhoParte1 >= tamanhoParte1Buffer || tamanhoParte2 >= tamanhoParte2Buffer) {
        return 0;
    }
...
int main()
{
    ...
    if (dividirTexto(texto, parte1, sizeof(parte1), parte2, sizeof(parte2))) {
        ...
        printf("A string não pôde ser dividida com segurança.\n");
    }
